...
#############  program name
	...
	STM32L_LIB_DIR		= $(ROOT_DIR)/stm32f4_lib
	CMSIS_DIR			= $(STM32L_LIB_DIR)/CMSIS
	STDPERIPH_DIR		= $(STM32L_LIB_DIR)/STM32F4xx_StdPeriph_Driver
...
# STM32F10X_XL    : STM32 XL-density devices
	...
	STARTUP 	= $(CONF_DIR)/startup_stm32f4xx.s
...
# source directories (all *.c, *.cpp and *.s files included)
	...
	DIRS	+= $(CMSIS_DIR)/Device/ST/STM32F4xx/Include
